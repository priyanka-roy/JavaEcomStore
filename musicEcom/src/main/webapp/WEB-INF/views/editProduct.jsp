...
<div class="container-wrapper">
        ...
        <form:form action="${pageContext.request.contextPath}/admin/productInventory/editProduct"
         ...
         <form:hidden path="productId" value="${product.productId}" />
            ...
            <div class="form-group">
                ...
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="superfood" />SuperFood</label>
            </div>
 ...
 --%>
            <div class="form-group">
                ...
                <label class="checkbox-inline"><form:radiobutton path="productStatus" id="status" value="notavailable" />NotAvailable</label>
            </div>
